...
import { PhBaseButton, PhBaseImage, PhBaseRichArea } from '@tg/bccomponents'
...
<template>
  <div class="mx-auto max-w-[650rem] w-full flex flex-col gap-[16rem] pb-[60rem] @md:pt-[32rem]">
    <div class="center">
      <PhBaseImage :class="isJumpOut ? 'cursor-pointer' : ''" class="set-radios" is-network :url="configData?.image" loading="eager" @click="onBannerClick" />
    </div>
    <!-- 玩法规则 -->
