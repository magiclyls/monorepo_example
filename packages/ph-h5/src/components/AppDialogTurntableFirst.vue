...
const rouletteStyles = ref<RouletteStyle[]>([
  {
    ...
    topBackgroundImage: { url: '/ph-h5/png/before-top-background.png', width: 49, left: 140, right: 0, top: 60, bottom: 0 },
  ...
  <div class="center fixed left-0 top-0 h-[100%] w-[100%]" @click="handleClose" @touchmove.stop.prevent>
    <div class="margin-auto relative h-[386rem] w-[332rem]">
      ...
      <div class="absolute m-auto" :style="{ width: `${getRouletteStyle(currentStyleId)?.width}` }">
        <!-- 转盘彩带 -->
        <div v-if="currentStyleId === 'style_1'" class="absolute bottom-[-24rem] left-[30rem] z-[4] w-[284rem]">
          <PhBaseImage url="/ph-h5/png/before-front-background.png" />
        </div>
        <div
