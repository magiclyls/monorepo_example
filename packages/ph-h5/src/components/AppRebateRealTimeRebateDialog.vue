...
<template>
  <div class="p-[16rem] pt-0 flex flex-col" @touchstart.stop @touchmove.stop>
    <template v-if="page === 1">
      <div class="flex items-center justify-between mb-[16rem]">
        <h2 class="flex items-center">
          <IconUniRebate class="text-[16rem] text-[#9DABC8]" />
          <span class="text-[#0D2245] text-[18rem] leading-[25rem] font-[600] ml-[8rem]">{{ rebateAutomatic && +rebateAutomatic.automatic === 3 ? t('实时返水') : t('返水') }}</span>
        </h2>
        <div class="text-[18rem] flex items-center cursor-pointer text-[#9DABC8]" @click.stop="close">
          <IconUniClose3 />
        </div>
      </div>
    ...
    <template v-else-if="page === 2">
      <div class="flex flex-col" @touchstart.stop @touchmove.stop>
        <div class="flex items-center justify-between mb-[16rem]">
          <h2 class="flex items-center">
            <IconUniRebateDetail class="text-[16rem] text-[#9DABC8]" />
            <span class="text-[#0D2245] text-[18rem] leading-[25rem] font-[600] mx-[8rem]">{{ t('详情') }}</span>
        ...
        <div class="scroll-y flex flex-1 flex-col" @touchstart.stop @touchmove.stop>
          <div>
            <PhBaseTable
              ...
              style="--tg-table-th-height:48rem;--tg-table-td-height:48rem;--tg-table-odd-background:#F6F7F8;--tg-table-td-padding-x:10rem;"
