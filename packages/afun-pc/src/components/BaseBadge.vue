...
:root{
  ...
  --tg-badge-background-color: var(--tg-primary-active);
}
</style>
...
.active-badge{
  ...
  @include webTheme('white') {
    --tg-badge-background-color: var(--tg-white-primary-active-bg);
  }
  @include webTheme('greenblack') {
    --tg-badge-background-color: #FFB241;
  }
}
.black-badge{
  ...
  @include webTheme('green') {
    --tg-badge-background-color: #19412e;
  }
  @include webTheme('white') {
    --tg-badge-background-color: #373737;
    --tg-badge-color: white;
  }
  @include webTheme('greenblack') {
    --tg-badge-background-color: --tg-secondary-dark;
    --tg-badge-color: #dddddd;
  }
}
.default-badge{
  ...
  @include webTheme('greenblack') {
    --tg-badge-background-color: var(--tg-primary-active);
    --tg-badge-color: var(--tg-text-black) ;
  }
  @include webTheme('white') {
    --tg-badge-background-color: var(--tg-white-primary-active-bg);
  }
...
.red-badge{
  --tg-badge-background-color: var(--tg-primary-fail);
  --tg-badge-color:  white;
}
.m-badge {
  line-height: 1;
