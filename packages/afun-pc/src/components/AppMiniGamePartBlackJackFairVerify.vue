...
import { IconUniArrowDown, IconUniArrowUpSmall2, IconChessPlinko } from '@tg/icons'
...
<template>
  <div>
    ...
    <div class="flex-col-16 flex flex-col p-[16px]">
      <div
        class="border-tg-secondary text-lfet min-h-[200px] flex flex-col items-center justify-center border-[2px] rounded-[8px] border-dotted p-[16px]"
      >
        <!-- no result -->
    ...
    <div class="flex-col-16 bg-tg-secondary-dark flex flex-col p-[16px]">
