...
import { IconUniShareSlip, IconUniTrend, IconSptLive } from '@tg/icons'
    ...
    <div class="record">
      <div class="header">
        ...
        <BaseButton v-if="!isDialog" type="text" size="none" @click="showDetail">
          <IconUniShareSlip name="uni-share-slip" />
        </BaseButton>
      </div>
          ...
          >
            <div class="overview">
              ...
              <div class="wrapper">
                ...
                <div class="icons">
                  <IconUniTrend name="uni-trend" />
                  <IconSptLive name="spt-live" />
