...
import { Column, EnumCasinoPidToVid, EnumGlobalGameType, type ICasinoBetRecordItem } from '@tg/types'
...
<template>
  <div class="min-h-[237px]">
      ...
      <BaseTable v-else :loading="loading" :columns="columns" :data-source="list" class="table" :skeletonRow="4">
