...
:root {
  ...
  --tg-base-tab-color: var(--tg-text-white);
  --tg-base-tab-active-color: #000;
  --tg-base-tab-background-color: none;
...
.base-tab-wrap {
  ...
  .tab {
    ...
    background-color: var(--tg-base-tab-background-color);
    ...
    &:hover:not(.disabled):not(.is-mobile) {
      ...
      color: var(--tg-base-tab-active-color);
