...
<template>
  <div class="w-full flex flex-col gap-[16px] pb-[32px]">
    <div class="box-outer">
      <div class="px-[16px]">
        <h6 class="text-[20px] font-[600] text-[#fff] leading-[28px] mb-[20px]">{{ t('set_your_betting_limits') }}</h6>
      ...
      <div class="line"></div>
      <div class="px-[16px] flex flex-col gap-[16px] max-w-[420px]">
      ...
      <div class="flex justify-end px-[16px]">
        <BaseButton :disabled="Number(amount) <= 0" @click="onBetLimitInsertClick" bg-style="primary" class="h-[42px]"
