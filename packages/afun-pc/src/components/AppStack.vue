...
<template>
  <div class="app-pagination">
    <BaseButton
      style="--tg-text-dark: #8b959b"
      bgStyle="grey" class="pagination-previous mr-[24px]" :disabled="props.paginationData.total === 0
    ...
    <BaseButton
      style="--tg-text-dark: #8b959b"
      bgStyle="grey"  class="pagination-next" :disabled="props.paginationData.total === 0
