...
import { IconUniArrowGodown, IconUniPairRight } from '@tg/icons'
      ...
      <div class="flex flex-col gap-[12px]">
        ...
        <template v-if="!isH5">
          <BaseButton class="gameButton" shadow size="lg" :disabled="formDisabled || !isBet" @click="betThrottle(getUpBtn.betVal, 1)">
            ...
            <component :is="getUpBtn.betIcon" class="mx-[8px]" style="--tg-icon-color: #ffce00" />
          ...
          <BaseButton class="gameButton" shadow size="lg" :disabled="formDisabled || !isBet" @click="betThrottle(getDownBtn.betVal, 2)">
            ...
            <component :is="getDownBtn.betIcon" class="mx-[8px]" style="--tg-icon-color: #7F47FD" />
...
.game-right {
  --bgHi: url(/afun-pc/img/game/game_hilo_bg_hi.svg);
  --bgLo: url(/afun-pc/img/game/game_hilo_bg_lo.svg);
  --bgHiStacked: url(/afun-pc/img/game/game_hilo_bg_hi_stacked.svg);
  --bgLoStacked: url(/afun-pc/img/game/game_hilo_bg_lo_stacked.svg);
  --btn-hi: url(/afun-pc/img/game/game_hilo_button_hi.svg);
  --btn-lo: url(/afun-pc/img/game/game_hilo_button_lo.svg);
  @include webTheme('greenblack') {
    --bgHi: url(/afun-pc/img/game/game_hilo_bg_hi_greentheme.svg);
    --bgLo: url(/afun-pc/img/game/game_hilo_bg_lo_greentheme.svg);
    --bgHiStacked: url(/afun-pc/img/game/game_hilo_bg_hi_stacked_greentheme.svg);
    --bgLoStacked: url(/afun-pc/img/game/game_hilo_bg_lo_stacked_greentheme.svg);
  }
  @include webTheme('green') {
    --bgHi: url(/afun-pc/img/game/game_hilo_bg_hi_greentheme.svg);
    --bgLo: url(/afun-pc/img/game/game_hilo_bg_lo_greentheme.svg);
  ...
  @include webTheme('white') {
    ...
    --bgHi: url(/afun-pc/img/game/game_hilo_bg_hi_white.svg);
    --bgLo: url(/afun-pc/img/game/game_hilo_bg_lo_white.svg);
    --bgHiStacked: url(/afun-pc/img/game/game_hilo_bg_hi_stacked_white.svg);
    --bgLoStacked: url(/afun-pc/img/game/game_hilo_bg_lo_stacked_white.svg);
  }
  .pc-bg {
    flex: 1;
