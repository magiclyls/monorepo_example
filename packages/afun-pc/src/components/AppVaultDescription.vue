...
function handleTabChange(value: { value : 'deposit' | 'withdraw'}){
...
<template>
  <div>
    <BaseTabWrap class="mb-[24px]" :list="tabOptions" :active="activeTab" @itemClick="handleTabChange">
      <template #item="{ item }">
    ...
    <div class="bg-[#1A2C38] p-[24px] rounded border-[1px] border-[#2F4553]">
  <div class="text-tg-text-white w-full">
    <AppSafeDialog :show-bottom="false" :need-await="false" @change="changeCurrency"  :activeTab="activeTab"/>
    <!-- <component :is="AppSafeDialog" :show-bottom="false" :need-await="false" @change="changeCurrency" /> -->
  </div>

  <div
    class="w-full select-none @md:my-[16px] @md:rounded-[8px] @md:p-[20px] @md:pb-[24px]" :class="{
      'bg-rule-h5': isMobile,
      'bg-rule-pc': !isMobile,
    }"
  >
    ...
    <div class="scroll-x">
      ...
      >
        <div class="text-tg-secondary-light desc-item w-fit shrink-0 whitespace-nowrap text-center text-[14px] font-semibold leading-[20px]">
          ...
          <div class="theme-text bg-tg-secondary-grey h-[48px] rounded-l px-[80px] flex items-center justify-center  @md:px-[15px]">
        ...
        <div class="text-tg-secondary-light desc-item w-fit flex-1 shrink-0 whitespace-nowrap text-center text-[14px] font-semibold leading-[20px]">
          ...
          <div class="bg-tg-secondary-grey theme-text h-[48px] rounded-r flex items-center justify-center px-[80px] @md:px-[15px]">
