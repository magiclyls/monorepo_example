...
import type { PokerCardItem } from '~/types'
...
<template>
  <div ref="gameBlackJackRef" class="w-full">
    <div
      ...
      class="hands relative grid h-fit min-h-[250px] w-full content-between gap-[14px] bg-[length:40%] bg-center bg-no-repeat @md:h-auto"
    >
      <div class="text-tg-secondary-light desc text-center text-sm font-semibold leading-[20px]">
        {{ $t('dealer') }}
      </div>
      ...
      <div class="content scroll-x random-cards w-full">
        <div class="wrap w-full">
          <div class="wrap">
            <div class="slide-down w-fit flex items-center justify-center gap-[8px]">
