    ...
    <template v-if="litems.length === 0">
      <div v-show="showTitle" class="mb-[10px] flex items-center justify-between">
        ...
        <div class="right-wrap flex">
          <BaseButton
            v-if="total"
            type="default" class="h-[28px] rounded-lg bg-[#454545]" style="--tg-base-button-style-bg : #F5F5F5;--tg-base-button-padding-x:18px; --tg-base-button-font-size:16px;"
            @click="_push"
          >
      ...
      <!-- 普通的游戏列表 -->
      <AppCardListWhite v-show="!searchValue.length" :list="list" />
