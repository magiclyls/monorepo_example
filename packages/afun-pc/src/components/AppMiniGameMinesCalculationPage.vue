...
<template>
  ...
  <BaseLabel class="mb-[16px]" :label="$t('client_seed')">
    <BaseInput v-model="minesParams.clientSeed" type="text" msg-after-touched />
  </BaseLabel>
  <BaseLabel class="mb-[16px]" :label="$t('server_seed')">
    <BaseInput v-model="minesParams.serverSeed" type="text" msg-after-touched />
  </BaseLabel>
  ...
  <BaseLabel class="mb-[16px]" label="Mines">
    <BaseSelect
      ...
      <div class="w-full">
        ...
        <div class="flex-col-16 flex flex-col">
          <span class="text-tg-text-white text-[14px] font-semibold leading-[1.5] font-mono">
            {{ t('hum_value') }}{{ t('colon') }}{{ resultMap.renderValues.join(', ') }}
          </span>
          <div>
            ...
            <p class="text-tg-text-white text-[14px] font-semibold leading-[1.5] font-mono">
              (x, y) {{ t('start_from_left_bottom') }}
            </p>
          </div>
          <span class="text-tg-text-white text-[14px] font-semibold leading-[1.5] font-mono">
            {{ t('mines_xy') }}{{ t('colon') }}{{ resultMap.minesCoordinate.join(', ') }}
          </span>
        </div>
      </div>
      <div>
