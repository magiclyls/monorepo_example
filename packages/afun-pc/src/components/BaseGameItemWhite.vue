...
import { IconNavbarUser, IconUniMaintain, IconWhiteStar, IconWhiteStarActive } from '@tg/icons'
  ...
  <BaseAspectRatio class="game-ratio" ratio="100/134.1463414634" style="overflow: hidden;">
    <div class="base-game-item" :class="{ maintain: isMaintained }" @click="gameStart">
      <div class="backgrop-filter">
        <BaseImage
          v-if="thumbnailStatus" style="--tg-base-img-style-radius:8px;" is-cloud
      ...
      <BaseImage
        v-if="!isError && showImg" :url="gameImgUrl" loading="eager" :name="gameInfo.name" is-cloud
