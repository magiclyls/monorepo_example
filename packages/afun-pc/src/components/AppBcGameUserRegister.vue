...
import { IconUniArrowDown, IconUniBack, IconUniBcClose } from '@tg/icons'
  ...
  <div class="h-full">
    <div class="bc-game-register h-full @md:flex">
      <div class="header relative box-content h-[200px] w-full pt-0 @md:w-1/2">
        <img alt="top-img" class="absolute left-0 w-full overflow-hidden @md:relative" :src="`/afun-pc/png/home/bcgame_register_${isMobile ? 'h5' : 'pc'}.png`">
        <div class="absolute left-0 top-0 z-10 w-full flex items-center justify-between p-[16px] pb-[20px]">
          <img alt="logo" class="h-[32px] w-auto" src="/afun-pc/png/home/bcgame_logo.png">
                  ...
                  <template #left-icon>
                    <div class="relative flex items-center pl-[12px]" style="--tg-base-select-border: none;--tg-base-select-icon-right:6px;--tg-base-select-small-style-padding-right:22px;--tg-base-select-small-style-padding-left:5px;">
                      <div class="flex-1" style="width: 16px;">
                        <BaseImage v-if="areaCode && areaCode.length" height="16px" width="16px" :url="`/afun-pc/png/flag/${areaCode.slice(1)}.webp`" />
                      </div>
                      <BaseSelect
                        v-model="areaCode"
