  ...
  >
    <div class="overflow-hidden">
      <div ref="parent" class="overflow-scroll hide-scroll  relative items-center flex">
        ...
        >
          <div class="h-[20px] mr-[4px]">
            <BaseImage v-show="active === item.value" class="h-[20px] w-[20px]" is-network :url="changeActiveUrl(item.icon)" loading="eager" />
            <BaseImage v-show="active !== item.value" class="h-[20px] w-[20px]" is-network :url="item.icon" loading="eager" />
          </div>
