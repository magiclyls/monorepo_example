        ...
        >
          ...
          <template v-if="isBomb">
            <img
              ...
              src="/afun-pc/webp/mines/mine-effect.webp" alt=""
            >
...
.tg-gem,
.tg-bomb {
  background-image: url('/afun-pc/img/game/game-mines-diamond.svg');
  background-size: 70%;
...
.tg-bomb {
  background-image: url('/afun-pc/img/game/game-mines-bomb.svg');
}
