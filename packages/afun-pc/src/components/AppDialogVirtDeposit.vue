        ...
        <template v-else>
          ...
          <div v-if="isConfirmPayment" class="type-online-bank">
            <div class="bank-second">
              ...
              <div class="second-btns" style="--tg-spacing-12:28px">
                ...
                <BaseButton bg-style="primary" size="md" :loading="paymentDepositBankConfirmLoading" @click="runPaymentDepositBankConfirm(
                  { id: paymentDepositBankInfo?.id ?? '' })">
                  {{ t('already_deposit') }}
                </BaseButton>
              </div>
          ...
          <div v-else class="type-other">
            <div class="other-first">
              ...
              <!-- 充值金额面板 -->
              <BaseMoneyKeyboard v-if="oftenAmount && oftenAmount.length" :currency="activeCurrency.currency_id"
