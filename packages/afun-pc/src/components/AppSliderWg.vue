    ...
    <div class="header">
      <div class="title">
        <BaseButton type="text" size="none" style="--tg-base-button-text-default-color:var(--tg-text-white);"
          ...
          <div v-if="icon" class="icon" style="--app-sport-image-error-icon-size:16px;">
            <AppImage v-if="useCloudImg" class="icon-img" style="width: 16px;height: 16px;" active :url="icon" is-cloud
      ...
      <div class="right-wrap flex">
        ...
        <div v-if="showArrow" class="arrows">
          ...
          <BaseButton size="none" type="square-line" class="right" :disabled="showViewAll ? scrollLeftItemsCount + pageInfo.pageSize
    ...
    .arrows {
      ...
      button {
        ...
        @include webTheme('greenblack') {
          ...
          border-color: #26FFBE;
          --tg-icon-color: #26FFBE !important;
        }
      }
