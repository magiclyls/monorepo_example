...
<template>
  ...
  --tg-base-select-popper-label-color: var(--tg-text-lightgrey);">
      ...
      <div v-else class="flex flex-col gap-[8px] px-[12px] pb-[13px] pt-[12px]">
        ...
        <BaseButton class="theme-btn-color" size="md" bg-style="primary" style="--tg-base-button-font-size:16px;"
...
<style>
:root {
  --app-sports-floating-bet-ch-header-bg: #24ee89;
  --app-sports-floating-bet-ch-header-text-bg: #000;
  --app-sports-floating-bet-ch-header-text: #24ee89;
  --app-sports-floating-bet-ch-header-content-bg: #0f202e;
  --app-sports-floating-bet-ch-svg-color: #05080a;
  ...
  --app-sports-slider-quickAmount-active-border: #24ee89;
  --app-sports-slider-border: transparent;
  --app-sports-slider-active-bg: var(--tg-primary-active);
  --app-sports-slider-text: #000;
  --app-sports-slider-text-win: #000;
  --app-sports-slider-iocn1: #24ee89;
  --app-sports-slider-iocn2: #000;
}
</style>
