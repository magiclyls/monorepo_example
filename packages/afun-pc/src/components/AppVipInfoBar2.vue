...
// 预期返水的card只在返水页面显示
const isRebatePage = computed(() => route.fullPath.includes('/rebate-center?tab=rebate') || route.fullPath.includes('real-time-rebate'))
const isRebateRecordPage = computed(() => route.fullPath.includes('/rebate-center?tab=record')||route.fullPath.includes('real-time-rebate'))
// 显示vip info bar
