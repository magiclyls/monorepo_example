...
defineOptions({
  name: 'AppWalletDepositWalletDetailSubmitV3',
})
const { t } = useI18n()
...
const activeFiatCurrency = ref(JSON.parse((routeData?.activeCurrency || '{}') as string))
  ...
  <div class="app-wallet-dialog">
    <div class="type-online-bank">
      <div class="bank-second">
        ...
        <div
          class="bg-tg-secondary-dark border-tg-text-lightgrey w-full border-[2px] rounded-[4px] border-dashed px-[5px] py-[10px]"
        >
