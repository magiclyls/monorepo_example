      ...
      <div class="top">
        ...
        <div class="right">
          ...
          <BaseButton
            ...
            bg-style="primary" :disabled="exclude" @click="onSwitchRealMoneyMode(true)"
          >
          ...
          <div class="iframe-wrapper" :class="{ 't-iframe-wrapper': isTheatre }">
            <div v-if="isShowFrameOverlay" class="iframe-menu-overlay">
              <div class="content">
                ...
                <div class="btns">
                  <BaseButton
                    v-if="isLogin" class="real" size="sm" bg-style="primary" :disabled="exclude"
                  ...
                  <BaseButton v-else class="real" size="sm" bg-style="primary" @click="openRegisterDialog">
                    <div class="icon">
                      <IconUniPlay />
                    </div>
                    <span>{{ t('reg') }}</span>
