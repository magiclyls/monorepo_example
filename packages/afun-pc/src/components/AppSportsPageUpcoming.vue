  ...
  <div class="tg-sports-upcoming" :class="{ 'on-page': onPage }">
    <div class="sports-page-title">
      ...
      <AppSportsMarketTypeSelect
        v-model="baseType" v-model:is-standard="isStandard" :disabled="isAll"
    ...
    <div class="market-wrapper">
      <AppSportsMarketSkeleton v-if="switchLoading" :num="marketNum" :si="currentUpcomingNav" />
      <template v-else>
        <AppSportsMarket
