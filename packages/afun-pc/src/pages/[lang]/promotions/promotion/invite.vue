...
import { IconArrowDown, IconUniArrowRight, IconUniArrowRightSmall, IconUniClose } from '@tg/icons'
...
<template>
  <div class="mx-auto max-w-[650px] w-full flex flex-col pb-[16px] pt-[20px] @md:pt-[3px]2">
    ...
    <template v-else>
      ...
      <div class="bg-tg-secondary-dark order-4 mb-[16px] mt-[16px] w-full rounded-[4px] px-[14px] pb-[16px] pt-[13px]">
        <div class="mb-[6px] w-full flex items-center justify-between">
          ...
          <BaseButton
            v-if="!hideApplyBtn && isLogin && bonusAvailable" custom-padding bg-style="primary" style="
      ...
      <div v-if="ruleHtml" class="bg-tg-secondary-dark text-tg-secondary-light order-7 w-full rounded px-[14px] py-[18px]">
        ...
        <div class="mt-[16px] flex flex-col items-center">
          <BaseButton
            v-if="isShowBtn" bg-style="primary" size="lg"
    ...
    <img src="/afun-pc/webp/promotions/box_open1.webp" style="display:none;width:0;height:0;">
    <img src="/afun-pc/webp/promotions/box_open2.webp" style="display:none;width:0;height:0;">
    <img src="/afun-pc/webp/promotions/red_open1.webp" style="display:none;width:0;height:0;">
    <img src="/afun-pc/webp/promotions/red_open2.webp" style="display:none;width:0;height:0;">
  </div>
</template>
