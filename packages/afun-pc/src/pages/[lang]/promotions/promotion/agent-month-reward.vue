        ...
        <template v-if="isLogin">
          ...
          <template v-else-if="receiveState && +receiveState === 1">
            ...
            <template v-else>
              ...
              <BaseButton :loading="bonusLoading" class="mt-[10px] w-full" bg-style="primary" size="md" @click="getBonus">
                {{ t('vip_right_now') }}
              </BaseButton>
            </template>
          </template>
          ...
          <BaseButton v-if="!receiveState || (receiveState && +receiveState !== 1 && +receiveState !== 4) || (data && +data.activity_state === 25)" class="mt-[10px] w-full" bg-style="primary" size="md" @click="goPromo">
            {{ t('view_more_event') }}
          </BaseButton>
        </template>
        <template v-else>
