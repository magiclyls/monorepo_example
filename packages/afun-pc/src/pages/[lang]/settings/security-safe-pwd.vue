...
import { ApiMemberPayPasswordUpdate, ApiMemberSendMailCode } from '@tg/apis'
  ...
  <div class="tg-settings-security">
    ...
    >
      ...
      <div v-if="getMailState" class="mail-not-bind">
        ...
        <BaseButton size="none" type="text" style="--tg-base-button-text-default-color:#24EE89;" @click="emit('bind')">
          {{ t('go_bind') }}
        </BaseButton>
      </div>
      <template v-else>
        ...
        >
          <BaseInput
            ref="pwdRef" v-model="payPassword"
            input-mode="numeric"
            :msg="payPwdErrorMsg"
            type="password"
            max="6"
