...
import { AfunBaseButton, AfunBaseCheckbox, AfunBaseDialog, AfunBaseImage, AfunBaseInput, AfunBaseInputBirthday, AfunBaseOriginSelect, BaseForm } from '@tg/bccomponents'
...
import { application, brazilPhoneReg, chinaPhoneReg, emailReg, getEnv, lastOneNumberReg, Local, numberReg, payPasswordReg, philippinePhoneReg, sendMsgToFlutterThirdPartyApp, Session, Statistics, STORAGE_CCCCC, STORAGE_REG_PARAMS_KEYWORDS, STORAGE_THIRDREG_PARAMS_KEYWORDS, STORAGE_UUUUU, upperLowerReg, usernameReg2 } from '@tg/utils'
    ...
    <div class="relative w-full">
      ...
      <div class="px-[12px] bg-transparent pb-[30px] relative w-full -mt-[40px]">
        ...
        <BaseForm :schema="schema" autocomplete="off" @submit="onRegisterClick">
          <div v-if="regConfig === undefined" class="h-[55px]" />
          <AfunBaseInput
            v-if="needPhone"
            v-model="phone"
            name="phone"
          ...
          <AfunBaseInput
            ...
            class="mb-[12px]"
          />
          <AfunBaseInput v-if="isOpenCPFOnRegister" v-model="cpf" :required="true" name="cpf" :max="11" input-mode="numeric" placeholder="CPF" class="mb-[12px]" />
          ...
          <div class="w-full mb-[12px]">
            ...
            <AfunBaseInput v-if="isCode" v-model="parentUid" name="parentUid" class="mt-[4px]" :placeholder="$t('请输入推荐代码')" />
          </div>
