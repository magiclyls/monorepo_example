  ...
  >
    <template #left>
      <div class="game-blackjack-sidebar flex flex-col">
        <AfunBaseLabel class="order-first mb-[12px]" style="--afun-base-label-color:#B1BAD3" :label="t('投注额')" :right-text="currencyPrefix + betAmountMulRate">
        ...
        <div class="mid-buttons flex-col-12 mb-0 flex flex-col ">
          <div v-if="showInsurance" class="actions insurance grid grid-cols-2 grid-rows-2 gap-x-[8px] gap-y-[16px]">
            <div class="desc text-[#fff] col-span-full flex items-center justify-center font-[600]">
              {{ t('购买保险？') }}
            </div>
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="acceptInsuranceButton" @click="clickAcceptInsurance">
              <div class="call-card relative flex items-center">
                <span>{{ t('接受保险') }}</span>
              </div>
            </AfunBaseButton>
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="acceptInsuranceButton" @click="clickNoAcceptInsurance">
              <div class="stop-call relative flex items-center">
                <span>{{ t('不买保险') }}</span>
              </div>
            </AfunBaseButton>
          </div>
          <div v-else class="actions btns grid grid-cols-2 grid-rows-2 gap-x-[8px] gap-y-[16px] ">
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="callCardButton" @click="clickCallCard">
              <div class="call-card relative flex items-center">
                <span class="mr-[8px]">{{ t('叫牌') }}</span>
                <IconCallcard class="text-[#FF9E00]" />
              </div>
            </AfunBaseButton>
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="acceptInsuranceButton" @click="clickStopCallCard">
              <div class="stop-call relative flex items-center">
                <span class="mr-[8px]">{{ t('停叫') }}</span>
                <IconStopcall class="text-[#9000FF]" />
              </div>
            </AfunBaseButton>
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="splitButton" @click="clickSplitCard">
              <div class="split-card relative flex items-center">
                <span class="mr-[8px]">{{ t('分牌') }}</span>
                <IconSplitcard class="text-[#fff]" />
              </div>
            </AfunBaseButton>
            <AfunBaseButton style="--afun-base-button-secondary-background-color:#2f4553" type="secondary" :disabled="multipleButton" @click="clickMultiple">
              <div class="double-it relative flex items-center">
                <span class="mr-[8px]">{{ t('加倍') }}</span>
                <IconDoubleit class="text-[#fff]" />
              </div>
            </AfunBaseButton>
          </div>
        </div>
        <div class="bet-button order-first mb-[12px] w-full @md:order-last">
            ...
            <div class="dealer w-full flex justify-center">
              ...
              >
                ...
                <div
                  ...
                  class="text-[#fff] value none absolute left-full top-0 w-[7ch] translate-x-[-100%] translate-y-[-100%] rounded-full px-[2px] py-[1px] text-center  font-extrabold"
                  :class="{ 'duration-[300ms]': animateEnabled }"
                >
                  {{ dealerValueStr }}
                </div>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    class="value none text-[#fff] absolute left-full top-0 w-[7ch] translate-x-[-100%] translate-y-[-100%] rounded-full px-[2px] py-[1px] text-center  font-extrabold"
...
.game-blackjack {
  ...
  .hands {
    background-image: url(/afun-h5/svg/blackjackbg.svg);
