...
import { AfunBaseAmount, AfunBaseButton, AfunBaseCurrencyIcon, AfunBaseDialog, AfunBaseInput, AfunBaseLabel, AfunBaseSelect, AfunBaseTabs } from '@tg/bccomponents'
...
<template>
  ...
  >
    <template #left>
      <div class="grid w-full gap-y-[12px]">
        <AfunBaseTabs
          ...
          @change="resetGame"
        />
        <AfunBaseLabel class="order-first set-label-color" :label="t('投注额')" :right-text="currencyPrefix + betAmountMulRate" style="--afun-base-label-margin-bottom: 2px;">
        ...
        <AfunBaseLabel class="order-2 set-label-color" :label="t('风险')" style="--afun-base-label-margin-bottom: 2px;">
          <AfunBaseSelect
        ...
        <!-- 自动投注 -->
        <div v-show="isAutoBet" class="order-2 grid gap-y-[12px]">
          <AfunBaseLabel class="order-2 set-label-color" :label="t('投注次数')" style="--afun-base-label-margin-bottom: 2px;">
            <AppMiniGamePublicBetTimes v-model.number="betTimes" :disabled="isAutoStart" />
          </AfunBaseLabel>
          <AfunBaseLabel class="order-2 set-label-color" :label="t('若赢')" style="--afun-base-label-margin-bottom: 2px;">
            <AppMiniGamePublicAutoDouble v-model="percentIfWin" :disabled="isAutoStart" />
          </AfunBaseLabel>
          <AfunBaseLabel class="order-2 set-label-color" :label="t('若输')" style="--afun-base-label-margin-bottom: 2px;">
          ...
          <AfunBaseLabel
            ...
            style="--afun-base-label-margin-bottom: 2px;"
          >
            <AfunBaseInput
            ...
            >
              <template #right>
                <AfunBaseCurrencyIcon :currency-type="orderCurrencyType" />
              </template>
            </AfunBaseInput>
          </AfunBaseLabel>
          <AfunBaseLabel
        ...
        <AfunBaseButton
          v-if="isManual" class="theme-btn order-2 hidden h-[40px] @[800px]:block"
    ...
    <template #right>
      ...
      >
        ...
        <div class="relative grid grid-cols-8 mx-auto max-w-[780px] w-full gap-[0.75em]">
          <!-- 预加载 -->
          <object class="absolute z-[-10] h-0 w-0" type="image/svg+xml" data="/afun-h5/svg/keno_gem_animate.svg" />
          ...
          <div
            ...
            class="settleAmount-layer  max-w-[100%] min-w-[150px] border-[3px] rounded-[8px] border-solid text-center text-[14px] font-extrabold"
          >
            <div
        ...
        >
          ...
          <div class="grid w-full gap-[0.75em]" style="grid-template-columns: repeat(var(--keno-choose-count), 1fr);">
            <div
              ...
              class="bg-tg-secondary flex items-center justify-center rounded-[4px] shadow-tg-header-shadow"
            >
          ...
          <!-- hit odds -->
          <div
            class="bg-tg-secondary footer-bottom relative grid w-full gap-[1em] rounded-[4px] px-[4px] shadow-tg-header-shadow"
          ...
          >
            ...
            >
              <AfunBaseLabel :label="t('支付额')" style="--afun-base-label-margin-bottom: 2px;">
                <AfunBaseInput
              ...
              <AfunBaseLabel :label="t('获胜利润')" :right-text="hitOddsTableWinAmountMulRate" style="--afun-base-label-margin-bottom: 2px;">
                <AfunBaseInput
                  readonly style="--tg-base-input-height:39px;--tg-base-input-style-placeholder-opacity:1;"
              ...
              <AfunBaseLabel :label="t('胜算')" style="--afun-base-label-margin-bottom: 2px;">
                <AfunBaseInput
                  readonly style="--tg-base-input-height:39px;--tg-base-input-style-placeholder-opacity:1;"
            ...
            >
              ...
              <img
                ...
                src="/afun-h5/svg/keno_gem.svg" alt=""
              >
            </div>
          </div>
        </div>
