...
<template>
  ...
  >
    <template #left>
      <div class="unselectable grid w-full gap-y-[12px]">
        ...
        />
        <AfunBaseLabel class="order-first set-label-color" :label="t('投注额')" :right-text="currencyPrefix + betAmountMulRate">
        ...
        <div class="order-2 min-h-[59px]">
          ...
          <div v-show="isManual" class="order-2 flex flex-col gap-[12px]">
            ...
            >
              ...
              >
                <template #right>
                  <AfunBaseCurrencyIcon :currency-type="currentGlobalCurrencyMap.type" />
                </template>
              </AfunBaseInput>
            </AfunBaseLabel>
          </div>
          ...
          <div v-show="isAutoBet" class="order-2 grid gap-y-[12px]">
            ...
            >
              ...
              >
                <template #right>
                  <AfunBaseCurrencyIcon :currency-type="currentGlobalCurrencyMap.type" style="--tg-app-currency-icon-size:16px" />
                </template>
              </AfunBaseInput>
            </AfunBaseLabel>
    ...
    <template #right>
      <div class="unselectable main-game px-[16px] pb-[16px] pt-[48px] @[800px]:min-h-[630px]">
        <!-- 游戏历史数据 -->
        <div class="absolute right-[16px] top-[16px] w-full flex justify-end overflow-hidden">
        ...
        <!-- 游戏显示区 -->
        <div
          class="flex flex-1 items-center justify-center py-[32px] text-center text-[4em] font-semibold @[800px]:text-[8em]"
        >
          <span
            class="text-color"
        ...
        <!-- 底部参数 -->
        <div class="theme-grey-bg grid grid-cols-2 items-center gap-[8px] p-[16px]">
          <AfunBaseLabel :label="t('目标乘数')" class="set-label-color">
            <AppMiniGamePublicNumber
  ...
  <AfunBaseDialog v-model="showLimboGameInfoDialog" :icon="IconUniGameInfo" :title="t('游戏规则')">
    <AppMiniGamePartLimboGameInfo />
  </AfunBaseDialog>
  <AfunBaseDialog v-model="showLimboHotKeysDialog" :icon="IconUniKeyboard" :title="t('快捷键')">
    <AppMiniGamePartLimboHotKeys />
  </AfunBaseDialog>
</template>
