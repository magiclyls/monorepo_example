...
import { AfunBaseCurrencyIcon, AfunBaseDialog, AfunBaseInput, AfunBaseLabel, AfunBaseSelect, AfunBaseTabs, BaseAspectRatio } from '@tg/bccomponents'
  ...
  >
    <template #left>
      <div class="grid w-full gap-y-12">
        <AfunBaseLabel class="order-first mb-[10px] set-label-color" :label="t('投注额')" :right-text="currencyPrefix + betAmountMulRate" style="--afun-base-label-margin-bottom: 2px;">
          <div class="bg-[#13212d] rounded-[4px] border border-[#2f4553] border-solid p-[4px]">
            <AppMiniGamePublicBetAmount
              ref="betAmountRef"
              v-model="betAmount" style="--afun-base-button-border-radius:4px" :currency="orderCurrencyCode"
              :disabled="gameStatus.switch || orderLoading || disableAutoOptions"
            />
          </div>
        </AfunBaseLabel>
        <div class="order-4 mt-[10px] flex gap-12 @[800px]:flex-col">
          <AfunBaseLabel class="flex-1 @[800px]:order-2 set-label-color" :label="t('风险')" style="--afun-base-label-margin-bottom: 2px;">
            <AfunBaseSelect
          ...
          <AfunBaseLabel class="flex-1 @[800px]:order-3 set-label-color" :label="t('分段')" style="--afun-base-label-margin-bottom: 2px;">
            <AfunBaseSelect
        ...
        <AfunBaseTabs
          ...
          :type="6"
          class="order-last mt-[10px] @[800px]:order-1" :list="tabList" full
          style="--tg-tab-style-inner-padding-y:13px;--tg-tab-style-inner-padding-x:16px;"
        />
        <!-- 自动投注 -->
        <div v-show="isAutoBet" class="order-6 mt-[10px] grid gap-y-12">
          <AfunBaseLabel :label="t('投注次数')" class="mt-[10px] set-label-color" style="--afun-base-label-margin-bottom: 2px;">
            <AppMiniGamePublicBetTimes v-model.number="autoBetConfig.betTimes" :disabled="disableAutoOptions" />
          </AfunBaseLabel>
          <AfunBaseLabel :label="t('若赢')" class="mt-[10px] set-label-color" style="--afun-base-label-margin-bottom: 2px;">
            <AppMiniGamePublicAutoDouble v-model="autoBetConfig.incOnWin" :disabled="disableAutoOptions" />
          </AfunBaseLabel>
          <AfunBaseLabel :label="t('若输')" class="mt-[10px] set-label-color" style="--afun-base-label-margin-bottom: 2px;">
            <AppMiniGamePublicAutoDouble v-model="autoBetConfig.incOnLoss" :disabled="disableAutoOptions" />
          </AfunBaseLabel>
          <AfunBaseLabel :label="t('止盈')" class="mt-[10px] set-label-color" :right-text="currencyPrefix + stopOnProfitMulRate" style="--afun-base-label-margin-bottom: 2px;">
            <AfunBaseInput
            ...
            >
              <template #right>
                <AfunBaseCurrencyIcon :currency-type="currentGlobalCurrency" style="--tg-app-currency-icon-size:16px" />
              </template>
            </AfunBaseInput>
          </AfunBaseLabel>
          <AfunBaseLabel :label="t('止损')" class="mt-[10px] set-label-color" :right-text="currencyPrefix + stopOnLossMulRate" style="--afun-base-label-margin-bottom: 2px;">
            <AfunBaseInput
    ...
    <template #right>
      <div ref="wheelBoxRef" class="bg flex flex-1 flex-col" :style="{ minHeight: `${wheelBoxMinHeight}px` }">
        <div
          class="mx-auto max-w-[750px] w-full flex flex-1 flex-col items-center justify-center p-[10px]"
          :style="{ fontSize: `${wheelBoxFs}em` }"
        >
          <div class="w-full flex flex-col items-center justify-center">
            <BaseAspectRatio class="max-w-[325px] @[400px]:max-w-550">
          ...
          <div class="relative grid w-full gap-[1em]">
            ...
            >
              <AfunBaseLabel class="order-2 flex-1 set-label-color" :label="t('获胜利润')" style="--afun-base-label-margin-bottom: 2px;--afun-base-label-color: #B1BAD3">
                <div
                  class="bg-[#2f4553]  shadow-tg-box-shadow flex items-center justify-between rounded-[4px]"
                >
                  <div
                    class="text-[#fff] flex flex-1 text-[12px] items-center justify-between p-[0.5em] font-semibold leading-[1.5]"
                  >
                    <span>{{ winningProfit }}</span>
                    <AfunBaseCurrencyIcon style="--tg-app-currency-icon-size:16px" :currency-type="orderCurrencyType" />
                  </div>
                </div>
              </AfunBaseLabel>
              <AfunBaseLabel class="order-2 flex-1 set-label-color" :label="t('胜算')" style="--afun-base-label-margin-bottom: 2px;--afun-base-label-color: #B1BAD3">
                <div
                  class="bg-[#2f4553] text-[12px]  shadow-tg-box-shadow flex items-center justify-between rounded-[4px]"
                >
                  <div
