...
<template>
  <AppPageLayout :title="t('关闭账户')">
    <div
      class="py-[20rem] text-[#fff] px-[16rem] flex flex-col gap-[16rem] rounded-[4rem] bg-[#213743] border-[2rem] border-solid border-[#2F4553]"
      style="box-shadow:  0 1px 2px -1px rgba(0, 0, 0, 0.25), 0 2px 3px -1px rgba(0, 0, 0, 0.30);"
    >
      ...
      <div class="flex justify-end">
        <AfunBaseButton class="h-[42rem]" @click="openDialog">
          {{ t('请求关闭账户') }}
        </AfunBaseButton>
      </div>
    </div>

    <AfunBaseDialog v-model="show" :title="dialogTitle">
      123
    </AfunBaseDialog>
  </AppPageLayout>
</template>
