...
import { AfunBaseCurrencyIcon, AfunBaseInput, AfunBaseSelect, AfunBaseTable } from '@tg/bccomponents'
...
<template>
  <div>
    <BaseDatePicker
      ...
      show-tab
    />
    <div class="flex gap-[20px] my-[8px]">
      <AfunBaseSelect v-model="currency_id" :options="currencyList" active-color="#00AD01" class="flex-1" style="--afun-base-select-border-color: #0F212E;--afun-base-select-shadow: none" />
      <AfunBaseInput
        ref="newPwd"
        v-model="searchValue"
        type="text"
        class="flex-1"
        search
        style="--afun-base-input-padding-y:8px;--afun-base-input-border-color: #0F212E; --afun-base-input-style-placeholder-color: #B1BAD3;--afun-base-input-shadow: none"
        :placeholder="t('搜索账号')"
      />
    </div>
    <AfunBaseTable
