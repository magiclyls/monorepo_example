...
<template>
  <AppHomeLayout>
    ...
    <div v-else class="afun-active px-[10px] pt-[8px]">
      <AfunBaseTabs v-model="tabVal" :type="3" :list="allTabs" style="--afun-tabs-wrap-padding-x:4px;--afun-tabs-font-size:16px;" class="mb-[12px] mt-[8px]" />
      <keep-alive>
