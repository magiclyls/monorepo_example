...
<template>
  <div class="w-full flex flex-col overflow-hidden">
    <AfunBaseTable
      ...
      style="--afun-table-th-height:48px;--afun-table-td-height:48px;--afun-table-td-font-weight:500;"
    >
      ...
      <template #daily_gift="{ record: { dailyGift } }">
        ...
        <div v-else class="center">
          <AfunBaseAmount :amount="dailyGift" :currency-type="currencyModeCur" style="--afun-app-amount-font-weight:500;--afun-base-amount-font-size: 14px;" />
        </div>
      </template>
      <template #weekly_gift="{ record: { weeklyGift } }">
        ...
        <div v-else class="center">
          <AfunBaseAmount :amount="weeklyGift" :currency-type="currencyModeCur" style="--afun-app-amount-font-weight:500;--afun-base-amount-font-size: 14px;" />
        </div>
      </template>
      <template #monthly_gift="{ record: { monthlyGift } }">
        ...
        <div v-else class="center">
          <AfunBaseAmount :amount="monthlyGift" :currency-type="currencyModeCur" style="--afun-app-amount-font-weight:500;--afun-base-amount-font-size: 14px;" />
        </div>
      </template>
    </AfunBaseTable>
