...
<template>
  <AppPageLayout :title="t('兑换码')">
    <div class="w-full flex flex-col">
      <AfunBaseInput v-model="coupon" msg-after-touched :max="8" :msg="errorMessage" name="" :placeholder="t('请输入兑换码')" style="--afun-base-input-error-text-color: #B1BAD3;" />
      <AfunBaseButton :loading="loading" class="mt-[16px]" style="--afun-base-button-padding-y:10px;" show-shadow @click="submit">
        {{ t('提交') }}
      </AfunBaseButton>
    </div>
  </AppPageLayout>
