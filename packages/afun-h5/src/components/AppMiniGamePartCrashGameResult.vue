...
<template>
  <div ref="gameBlackJackRef" class="w-full">
    ...
    <div
      ...
      class="box w-full px-[16px] pb-[16px] mt-[15px]"
    >
      <div class="w-full flex grow flex-col items-center justify-center">
        <div class="wrap gap-[16px] mb-[16px] mt-12 w-full flex flex-col">
          ...
          <div>
            <AfunBaseInput readonly :model-value="betDetail.bet_point" style="--afun-base-input-background-color: #EBEBEB; --afun-base-input-border-color: transparent; --afun-base-input-padding-y: 9px" />
          </div>
        </div>
      </div>
      <!-- 前往游戏 -->
