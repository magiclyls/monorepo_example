...
<template>
  ...
  <!-- 结果 -->
  <div class="border-tg-secondary min-h-[200px] flex flex-col items-center justify-center border-2 rounded-[4px] border-dotted p-16">
  ...
  <!-- 计算明细 -->
  <div v-if="!hasResult" class="min-h-[200px] flex flex-col items-center justify-center rounded-[4px] p-16">
    <div class="ani-roll">
      <IconChessFrame2 />
    </div>
  </div>
