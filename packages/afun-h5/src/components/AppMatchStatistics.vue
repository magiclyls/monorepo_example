...
import { AfunBaseSkeleton } from '@tg/bccomponents'
    ...
    >
      ...
      <div class="sticky-left competitor-item with-border" style="grid-area: competitor_home;">
        <template v-if="showSkeleton">
          <AfunBaseSkeleton width="20px" height="20px" style="--tg-skeleton-border-radius:3px" />
          <AfunBaseSkeleton style="margin-left: 8px;--tg-skeleton-border-radius:3px" width="100px" height="16px" />
        </template>
        <template v-else>
          <AppImage :url="_data.htpic" class="flex-none" is-network width="14px" height="14px" />
      ...
      <div class="competitor-item sticky-left" style="grid-area: competitor_away;">
        ...
        <template v-else>
          <AppImage :url="_data.atpic" class="flex-none" is-network width="14px" height="14px" />
      ...
      <template v-if="!showSkeleton">
        ...
        <div class="heading center sticky-right flex-none" style="grid-area: matchScore_title;">
          <AppImage :url="sportsIconPathFormatBySite(_data.spic)" is-network width="14px" height="14px" />
        </div>

        <!-- matchScore -->
        <div class="fill-frame sticky-right completed match-score with-border min-w-[33px]" style="grid-area: matchScore_home;">
...
<style lang="scss">
:root {
  --tg-app-match-statistics-max-width: calc(100% - 28px);
}
</style>
