...
import { AfunBaseTable } from '@tg/bccomponents'
...
<template>
  <div class="p-[16px]">
    <AfunBaseTable class="table-wrapper" :columns="tableColumnheader" last-first-padding :data-source="tableDataheader" />
    <div class="line" />
    <AfunBaseTable class="table-wrapper" :columns="tableColumn" last-first-padding :data-source="tableData" :loading="loading1 || loading2" />
...
.table-wrapper {
  --afun-table-tr-last-first-padding: 3px;
  --afun-table-th-padding-x: 3px;
  --afun-table-td-padding-x: 3px;
}
</style>
