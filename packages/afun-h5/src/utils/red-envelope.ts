...
const configs = {
  red: {
    ...
    images: '/afun-h5/special/dollar_bg.webp',
    rotate: false,
    gapTime: 800,
    offsetX: 20,
  },
  dollar: {
    ...
    images: getImageUrl('/m/afun-h5/png/brl_bg.png'),
    rotate: true,
    gapTime: 500,
    offsetX: 20,
  },
  diamond: {
    ...
    images: [getImageUrl('/m/afun-h5/png/crystal-style-1.png'), getImageUrl('/m/afun-h5/png/crystal-style-2.png'), getImageUrl('/m/afun-h5/png/crystal-style-3.png')],
    rotate: false,
    gapTime: 800,
    offsetX: 20,
  },
...
export class RedEnvelopeItem {
  ...
  appendText(dom: HTMLDivElement, name: TypeRedEnvelope, w: number) {
    ...
    const currentFont = this.lang === 'zh-CN' ? `${fontSize}px` : `${otherFont}px`
