...
const cpf = ref(customRouter.query.cpf as string)
const currencyId = ref(customRouter.query.currencyId as CurrencyCode)
const currencyName = ref(customRouter.query.currencyName as string)
const isEdit = computed(() => customRouter.query.isEdit as unknown as boolean || false)
...
const isFirst = ref(customRouter.query.isFirst as unknown as boolean || false)
...
const openName = computed(() => customRouter.query.openName as string || realNameBRL.value)
...
<template>
  <form class="flex flex-col gap-[16px] pt-[16px]">
    ...
    <BaseButton
      ...
      bg-style="secondary" size="md" @click="onSubmit"
    >
      {{ t('confirm_bind') }}
    </BaseButton>
  </form>
