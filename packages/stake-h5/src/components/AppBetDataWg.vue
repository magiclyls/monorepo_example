...
import { IconUniHidden, IconUniRank1, IconUniRank2, IconUniRank3, IconSptCompetition, IconUniTrend } from '@tg/icons'
    ...
    <template v-if="selectSize !== '0'">
      ...
      >
        ...
        <template #settle_amount="{ record: { settle_amount, currency_id } }">
          <div :style="{ display: 'inline-block', color: settle_amount > 0 ? 'var(--tg-text-green)' : '' }">
            <AppAmount
