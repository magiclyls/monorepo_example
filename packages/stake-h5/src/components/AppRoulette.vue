  ...
  <div>
    <div class="relative m-auto h-[237px] w-[237px] overflow-hidden">
      <div class="absolute left-[0] top-[0] h-[100%] w-[100%]">
        <BaseImage class="h-[100%] w-[100%]" url="/png/promotions/zp-border.png" loading="eager" />
      </div>
      <div class="absolute left-[50%] top-[50%] z-[1] translate-x-[-50%] translate-y-[-53%]">
        <BaseImage class="absolute w-[66px] rounded-[50%]" url="/png/promotions/game-select.png" loading="eager" />
      </div>
      <BaseImage class="lamp absolute left-[1%] top-[1%] h-[98%] w-[98%]" url="/png/casino/flashing_light.png" loading="eager" />
      <div
        class="absolute left-[50%] top-[50%] ml-[-42.6%] mt-[-42.6%] h-[85.1%] w-[85.1%] overflow-hidden rounded-[50%]"
      >
        <div ref="drawRef" class="draw-content h-[100%] w-[100%]">
          <BaseImage class="absolute h-[100%] w-[100%] rounded-[50%]" :url="userLanguage === 'zh-CN' ? '/png/promotions/roulette-zh.png' : '/png/promotions/roulette.png'" loading="eager" />
        </div>
      ...
      <div
        class="absolute left-[50%] top-[50%] z-[1] h-[74px] w-[66px] translate-x-[-50%] translate-y-[-50%] cursor-pointer text-center leading-[74px] text-[#ffffff]"
        @click="startRotate"
      >
        <div v-show="isBox" class="center h-full w-full break-all px-[6px] pt-[4px] text-[14px] leading-[1.1] font-[600]">
          +{{ amount ?? 0 }}
        </div>
        <div v-show="!isBox">
          <div class="font-[600]">
