    ...
    >
      ...
      >
        <template v-for="menuitem in menu.value" :key="menuitem.title">
          <li
            v-if="menuitem"
            class="flex-col-center tiny-menu-item"
            :class="{
              active: $route.fullPath === `/${getCurrentUrlLanguage()}${menuitem.path}` || $route.path === `/${getCurrentUrlLanguage()}${menuitem.path}`,
              disabled: (menuitem.token && !isLogin) || (menuitem.sptToken && !isSportsLoginSusses),
            }"
          >
            <VTooltip placement="top">
              ...
              >
                <AppImage
                  ...
                  :url="menuitem.icon" is-cloud with-theme
                  class="icon-img"
                />
                <component v-else :is="menuitem.icon" />
                <div
                  v-if="menuitem && menuitem.list && menuitem.list.length"
