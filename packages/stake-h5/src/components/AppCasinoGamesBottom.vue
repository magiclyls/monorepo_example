...
const { cateProviderData, casinoRecData, cateHotData ,globleDisplay_num } = storeToRefs(casinoStore)
...
const currentSlider = computed(() => appSliderObj[0])
