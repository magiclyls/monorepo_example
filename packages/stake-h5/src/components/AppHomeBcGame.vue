...
<template>
  <div data-cl="casino-bc" class="casino-bc">
    <div class="layout-spacing">
      <div class="">
        <AppBannerBC type="casino" />
      </div>

      <!--  <div v-if="marqueeData && marqueeData.length" class="mx-[3vw] mt-[7px] flex items-center gap-[5px] pl-[2px]">
