...
import { IconUniWarningColor, IconUniArrowUpSmall } from '@tg/icons';
      ...
      <div class="input-wrap">
        ...
        <div class="select-wrap">
          ...
          <div class="dropdown-icon-wrap">
            <IconUniArrowUpSmall name="uni-arrow-up-small" />
          </div>
        </div>
        <!-- 年 -->
        <input ref="yearInputRef" v-model="year" :class="{ error: errorYearMsg || showAllRed }" type="number"
          :min="1900" placeholder="YYYY" @input="onInput">
      </div>
    </div>
...
:root {
  --tg-input-select-bg-color: #ffffff;
}
...
.base-input-birthday {
  ...
  .input-wrap {
    ...
    select {
      ...
      @include webTheme('white') {
        background-color: var(--tg-input-select-bg-color);
