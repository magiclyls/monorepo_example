...
import { IconSptUserAdd, IconUniArrowDown, IconWalletSet } from '@tg/icons'
interface Props {
  popperClazz?: string
}
defineOptions({
...
<template>
  <div class="app-wallet flex-box">
    <VDropdown
      ...
      @hide="handleHide"
    >
      <div class="wallet-box flex items-center">
        <BaseButton
          class="wallet" type="text"
          :custom-padding="isMobile" style="--tg-base-button-padding-x: 0;--tg-base-button-padding-y: 10;--tg-radius-default:0;"
        >
...
[theme="white"] {
  ...
  --tg-popper-bg:#f5f5f5;
  --tg-top-search-border-color:#C1C1C1;
...
.theme-amount{
  // --tg-app-amount-float: left;
  --tg-app-amount-max-width: 105px;
}
.wallet-box {
...
.app-wallet {
  .wallet {
    flex:1;
    --tg-base-button-justify-content: space-between;
  ...
  .wallet-right-btn {
    --tg-base-button-padding-y: 6px;
    --tg-base-button-padding-x: 6px;
    --tg-icon-color: white;
    font-size: 16px;
    margin-left: 5px;
    @include webTheme('green'){
