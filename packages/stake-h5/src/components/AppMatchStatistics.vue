...
<template>
  ...
  >
    ...
    >
      ...
      <div class="sticky-left competitor-item" style="grid-area: competitor_home;">
      ...
      <template v-if="!showSkeleton">
        <template v-if="isFootBall">
          ...
          <span class="fill-frame" style="grid-area: corners_home;">
          ...
          <span class="fill-frame" style="grid-area: yellowCards_home;">
          ...
          <span class="fill-frame" style="grid-area: redCards_home;">
      ...
      <span class="fill-frame" style="grid-area: gameScore_away;">
        ...
        <!-- matchScore -->
        <div
          class="fill-frame sticky-right completed match-score"
