...
<template>
  <div class="text-tg-text-lightgrey flex flex-col rounded-xl bg-light text-center">
    <h2
      class="xs:text-[20px] xs:leading-[28px] text-tg-text-white mt-[16px] px-[30px] text-[6.66vw] font-semibold leading-[9.06vw]">
      <div class="flex center">
        {{ currentTitle }}
<!--        <AppCurrencyIcon :currency-type="currentGlobalCurrency"-->
<!--                          style="&#45;&#45;tg-app-currency-icon-size: 20px"/>-->
      </div>
    </h2>
    <!-- max-h-[424px] -->
    <div class="scroll-y second-bg data-content mx-[10px] mt-[16px] flex-1 rounded-md p-[10px]">
      <BaseTable class="second-color"
                 style="--tg-table-th-height:48px;--afun-table-th-background:none;--afun-table-odd-background:#213743;--afun-table-td-height:48px;"
        ...
        <template #amount="{ record }">
          <div class="flex items-center justify-center">
            <AppAmount
              ...
              style="--tg-app-amount-font-size: 14px;"
            />
          </div>
        </template>
    ...
    <div class="flex flex-1 flex-col items-center justify-center px-[12px] py-[12px] bg-[#0F212E]">
      <BaseButton
        style="--tg-base-button-font-size:20px;--tg-spacing-button-padding-vertical-xs:9px;"
        class="w-full" bg-style="secondary" size="xs"
        @click="goLogin"
      >
        {{ t('goto') }}
      </BaseButton>
      <div class="mt-[10px] flex center"
           style="--tg-base-checkbox-box-width: 12px;">
