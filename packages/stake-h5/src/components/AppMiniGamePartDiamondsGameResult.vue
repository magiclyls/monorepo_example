...
<template>
  ...
  >
    <div class="tg-theme w-full flex grow items-end rounded-[8px] p-[16px]">
          ...
          <div class="relative h-full w-full">
            ...
            <div class="absolute left-[50%] top-[-8%] w-full translate-x-[-50%]">
              <transition name="fade">
                <object v-if="!!item" type="image/svg+xml" :data="`/img/game/diamonds_${item}.svg`" class="h-full w-full" />
              </transition>
            </div>
          </div>
        </div>
...
<style>
:root{
  --app-mini-game-diamonds-result-tile-before: #354452;
  --app-mini-game-diamonds-result-tile-after: #223843;
}
[theme="green"] {
  --app-mini-game-diamonds-result-tile-before: #076237;
  --app-mini-game-diamonds-result-tile-after:#055434;
}
</style>

<style lang='scss' scoped>
.tg-theme{
  background-color: var(--tg-sport-grey-deep);
