...
await application.allSettled([runGetRateFromTo()])
</script>

<template>
  <div class="wallet-wrap mb-[16px] flex flex-col gap-[14px]">
    ...
    <BaseButton
      size="md" style="--tg-base-button-font-size:16px;" bg-style="secondary"
