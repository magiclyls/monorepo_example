...
import { IconUniClose, IconUniTrend, IconSptLive, IconUniFullScreen } from '@tg/icons'
interface Props {
  type: 'trend' | 'live'
  url: string
...
.tg-base-drag-dialog {
  ...
  .header {
    ...
    .title {
      ...
      > *:not(:first-child) {
        margin-left: var(--tg-spacing-button-padding-horizontal-xs);
      }
