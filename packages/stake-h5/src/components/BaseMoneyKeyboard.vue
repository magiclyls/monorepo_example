        ...
        <BaseButton type="text" :style="computedStyle" @click="handleKey(item)">
           <div  class="flex flex-col" >
            <div class="flex"> 
              ...
              <!-- <span v-if="!application.isVirtualCurrency(getCurrencyConfigByCode(currency).name)" class="mr-4 text-[16px] font-[700] italic">{{ getCurrencyConfigByCode(currency).prefix
              }}&nbsp;</span> -->
...
.base-money-keyboard {
  ...
  .item-key {
    ...
    .item-svg {
      display: none;
      background-color: var(--base-money-keyboard-active-svg-bg);
      svg {
        fill: #05080a;
