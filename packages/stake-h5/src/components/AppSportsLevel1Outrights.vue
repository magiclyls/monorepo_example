...
import { IconSptSortAz, IconUniPopular, IconEmpty1 } from '@tg/icons'
...
<template>
  ...
  <div class="sub-wrapper">
    ...
    <AppSportsOutrightsRegion v-for="region, i in hotSportList" :key="region.pgid" :title="region.pgn"
      :icon="region.ppic" :init="i === 0" :count="region.cl.length" :league-list="region.cl" is-hot-game />
  ...
  <div class="sub-wrapper">
    <div class="sports-page-title">
      <div class="sports-page-title">
        <div class="left">
          <IconSptSortAz name="spt-sort-az" />
          <span>{{ $t('all') }} {{ sportName }} {{ t('champion_bet') }}</span>
        </div>
      </div>
    </div>
    <AppSportsOutrightsRegion v-for="region, in allRegionList" :key="region.pgid" :title="region.pgn"
      :icon="region.ppic" :init="false" :count="region.cl.length" :league-list="region.cl" />
