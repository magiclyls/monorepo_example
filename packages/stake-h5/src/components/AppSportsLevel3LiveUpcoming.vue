...
<template>
  <div class="sub-wrapper">
    ...
    <AppSportsMarket v-else :is-standard="isStandard" :league-name="navObj.cn" :event-count="total"
      :base-type="baseType" :event-list="list" :loading-more="moreLoading" group-by-date auto-show />
