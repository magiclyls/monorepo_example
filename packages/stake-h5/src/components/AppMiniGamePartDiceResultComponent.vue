      ...
      <div class="svelte translate">
        <div class="svelte translate-x" :style="{ transform: `translate(${randomNumber}%, 0px)` }">
          <div class="svelte hide-show" :class="[isWin ? 'positive' : 'negative']">
            <img class="svelte dice" src="/stake/img/game/classic-dice.svg" alt="Dice">
...
:root {
  ...
  --shadows-md:0 4px 6px -1px rgba(27, 23, 23, .2), 0 2px 4px -1px rgba(0, 0, 0, .12);
...
.hide-show.positive.svelte,.hide-show.negative.svelte {
