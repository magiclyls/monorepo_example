...
import type { ScrollPickerValue } from './AfunBaseScrollPicker.vue'
...
import AfunBaseScrollPicker from './AfunBaseScrollPicker.vue'
import AfunBaseTabs from './AfunBaseTabs.vue'
...
<template>
  <div class="flex flex-col gap-[16px]">
    <AfunBaseTabs v-if="showTab" v-model="tab" :list="tabList" :type="8" />
    <div class="bg-[#213743] rounded-[8px] py-[16px] px-[19px]">
      ...
      <AfunBaseButton class="w-full mt-[20px]" @click="changeDate">
        {{ t('确认') }}
      </AfunBaseButton>
    </div>
  </div>
