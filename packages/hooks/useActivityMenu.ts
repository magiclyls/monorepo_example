...
import { checkTs, getLangForBackend, i18n } from '@tg/vue-i18n'
...
export const useActivityMenu = createGlobalState(() => {
  ...
  function openActivity(item: PromoItem, entranceType?: 1 | 2 | 3) {
    ...
    // 调试用
    // goPromo(`/promotions/promotion/word-collection-roulette?pid=${180265}`)
    // return
    console.log(ty)
    switch (ty) {
      case 1:
      ...
      case 18:
        ...
        break
      case 19:
        goPromo(`/promotions/promotion/word-collection-roulette?pid=${pid}`)
        break
      default:
        break
    }
