...
<template>
  <div class="app-match-statistics wrapper has-background" :class="{ round }" :title="formatTitleData(_data)">
    ...
    >
      <!-- competitor -->
      <div class="chromatic-ignore sticky-left competitor-title heading items-center" style="grid-area: competitor_title;">
        <span
        ...
        <span class="match-status-label text-[9rem] whitespace-nowrap">
...
.competitor-title {
  background: var(--ss-spt-match-statistics-bg1);
}
...
.wrapper.has-background {
  ...
  &.round {
    border-radius: 4rem;
    overflow: hidden;
    box-shadow: var(--ss-spt-match-statistics-shadow1);
  }
}
...
.overtime {
  text-align: right;
  font-size: 14rem;
  color: var(--ss-spt-match-statistics-color1);
  padding: 8px;
}
...
.wrapper {
  ...
  .content {
    text-align: left;
    color: var(--ss-spt-match-statistics-color2);
    line-height: 1.5;
    font-size: 14rem;
    font-weight: 400;
    display: grid;
    background: var(--ss-spt-match-statistics-bg2);
    ...
    .heading {
      ...
      display: flex;
      text-align: center;
      background: var(--ss-spt-match-statistics-bg3);
    }
    ...
    .competitor-item {
      ...
      color: var(--ss-spt-match-statistics-color3);
      background: var(--ss-spt-match-statistics-bg4);
      ...
      img {
        width: 20rem;
        height: 20rem;
        fill: var(--ss-spt-match-statistics-bg5);
        margin-right: 8rem;
      }
    }

    .with-border {
      border-bottom: var(--ss-spt-match-statistics-border1);
    }
    ...
    .match-score {
      font-weight: 700;
      background: var(--ss-spt-match-statistics-bg6);
      color: var(--ss-spt-match-statistics-color4);
    }
  }
}
